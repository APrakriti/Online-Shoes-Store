...
import com.prakriti.myapplication.Adapter.PagerrAAdapter;
...
public class AdminUserDetails extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  toggle.syncState();
        ...
        final PagerrAAdapter adapter = new PagerrAAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(AdminUserDetails.this, AdminLogin.class);
            startActivity(i);
        }
